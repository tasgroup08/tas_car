...
int main(int argc, char** argv){
    ...
    waypoint4.position.x = 19.764;
    waypoint4.position.y =  21.744;
    waypoint4.orientation.x = 0.000;
    waypoint4.orientation.y = 0.000;
    waypoint4.orientation.z = 0.99977;
    waypoint4.orientation.w =  0.021566;
    ...
    waypoint3.position.x = 24.417;
    waypoint3.position.y = 9.0297;
    waypoint3.orientation.x = 0.000;
    waypoint3.orientation.y = 0.000;
    waypoint3.orientation.z =0.0193210;
    waypoint3.orientation.w = 0.99981;
