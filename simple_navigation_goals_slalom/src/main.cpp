...
int main(int argc, char** argv){
    ...
    geometry_msgs::Pose waypoint6;//guessed values
    waypoint6.position.x = 16.0;
    waypoint6.position.y =  8.7607;
    waypoint6.orientation.x = 0.000;
    waypoint6.orientation.y = 0.000;
    waypoint6.orientation.z = 0.99972;
    waypoint6.orientation.w =  0.02364;
